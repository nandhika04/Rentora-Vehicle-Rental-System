...
const DamageReview = () => {
  ...
  return (
    <div className="damage-review-container">
      <div className="damage-review-header">
        <h1 className="damage-review-title">🔍 Damage Review Dashboard</h1>
      ...
      <div className="damage-review-controls">
      ...
      <div className="damage-reports-section">
        ...
        {filteredReports.length === 0 ? (
          ...
          <div className="damage-reports-grid">
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  <div className="detail-item"><span className="detail-label">Report ID:</span><span className="detail-value">{selectedReport.id}</span></div>
                  <div className="detail-item"><span className="detail-label">Vehicle Type:</span><span className="detail-value">{selectedReport.vehicleType}</span></div>
                  <div className="detail-item"><span className="detail-label">Vehicle ID:</span><span className="detail-value">{selectedReport.vehicleId}</span></div>
                  <div className="detail-item"><span className="detail-label">Severity:</span><span className="detail-value">{selectedReport.severity}</span></div>
                  <div className="detail-item"><span className="detail-label">Estimated Cost:</span><span className="detail-value">{formatCurrency(selectedReport.estimatedCost)}</span></div>
                  <div className="detail-item"><span className="detail-label">Status:</span><span className="detail-value">{getStatusText(selectedReport.status)}</span></div>
                  <div className="detail-item"><span className="detail-label">Timestamp:</span><span className="detail-value">{formatDate(selectedReport.timestamp)}</span></div>
                </div>
              </div>
              ...
              {selectedReport.diffResult && (
                <div className="detail-section">
                  ...
                  <div className="detail-grid">
                    <div className="detail-item"><span className="detail-label">Severity Score:</span><span className="detail-value">{selectedReport.diffResult.severityScore}/100</span></div>
                    <div className="detail-item"><span className="detail-label">Damage Area:</span><span className="detail-value">{selectedReport.diffResult.damagePercentage.toFixed(2)}%</span></div>
                    <div className="detail-item"><span className="detail-label">Total Pixels Changed:</span><span className="detail-value">{selectedReport.diffResult.totalDiffPixels}</span></div>
                    <div className="detail-item"><span className="detail-label">Damage Regions:</span><span className="detail-value">{selectedReport.diffResult.regions.length}</span></div>
                  </div>
                        ...
                        {selectedReport.diffResult.regions.map((region, index) => (
                          <div key={index} className="region-detail-item">
                            <div className="region-header">
                              ...
                              <span className="damage-type">{region.classification.type.replace('_', ' ')}</span>
                            </div>
              ...
              {selectedReport.aiResult && (
                <div className="detail-section">
                  ...
                  <div className="detail-grid">
                    <div className="detail-item"><span className="detail-label">AI Service:</span><span className="detail-value">{selectedReport.aiResult.source}</span></div>
                    <div className="detail-item"><span className="detail-label">Confidence:</span><span className="detail-value">{(selectedReport.aiResult.confidence * 100).toFixed(1)}%</span></div>
                    <div className="detail-item"><span className="detail-label">Message:</span><span className="detail-value">{selectedReport.aiResult.message}</span></div>
                  </div>
                </div>
              )}
              ...
              <div className="detail-section">
                ...
                <div className="images-grid">
                  {selectedReport.beforeImageData && (
                    <div className="image-item">
                      <h5>📷 Before</h5>
                      <img src={selectedReport.beforeImageData} alt="Before" className="detail-image" />
                    </div>
                  )}
                  {selectedReport.afterImageData && (
                    <div className="image-item">
                      <h5>📷 After</h5>
                      <img src={selectedReport.afterImageData} alt="After" className="detail-image" />
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="modal-footer">
              {selectedReport.status === 'pending_review' && (
                <>
                  <button
                    onClick={() => { handleStatusChange(selectedReport.id, 'approved'); setShowDetails(false); }}
                    className="btn btn-success"
                  >
                    ✅ Approve Report
                  </button>
                  <button
                    onClick={() => { handleStatusChange(selectedReport.id, 'rejected'); setShowDetails(false); }}
              ...
              <button onClick={() => setShowDetails(false)} className="btn btn-secondary">✖️ Close</button>
            </div>
          </div>
        </div>
      )}
